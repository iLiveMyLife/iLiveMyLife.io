	...
	render() {
		...
		if (this.props.currentUser) {
            ...
            */
			...
			menuItems = [
				<Menu.Item key="/graph">
					<a href="https://app.ilivemylife.io/graph/000001736056c2cb-2655b2cf545d0001">
						Project's Graph
					</a>
				</Menu.Item>,
				<Menu.Item key="/login">
		...
		return (
			<Header className="app-header">
				<div className="container">
					...
					<div className="hamburger-menu" onClick={this.updateMenuStatus}>
