...
This folder contains the [Electron](https://electronjs.org/)-based desktop app for iLiveMyLife. Electron renders a web view, which renders the main `iLiveMyLife` webpage.
